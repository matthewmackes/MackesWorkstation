...
<!-- Mackes Workstation labwc menus. The root menu is the desktop right-click (Win2000
...
<openbox_menu>
  <menu id="root-menu" label="Mackes Workstation">
    <item label="Programs">
    ...
    <separator/>
    <item label="Set Up Mackes Workstation...">
