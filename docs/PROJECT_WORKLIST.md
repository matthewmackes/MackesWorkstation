...
- [ ] **Portal-8.b: Running-zone WM-buttons-on-hover** — 5 micro-buttons (close / float / full / minimize-to-scratchpad / layout-cycle) shown on hover per window group (R4-Q67 to R4-Q71).
